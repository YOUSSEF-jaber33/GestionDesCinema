...
public class CinemaInitServiceImpl implements ICinemaInitService {
	...
	public void initVilles() {
		Stream.of("casablanca","Berrechid","Marrakech","Rabat").forEach(nameVille->{
	...
	public void initFilms() {
		...
		Stream.of("Game of Thrones","Cukur","Vikings","Iron Man","Seigneur des anneaux").forEach(titreFilm->{
			Film film=new Film();
